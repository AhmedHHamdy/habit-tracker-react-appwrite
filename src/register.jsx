    ...
    <div className='flex flex-col min-h-screen'>
      ...
      <div className='flex-grow flex flex-col items-center justify-center'>
        ...
        <form className='flex flex-col space-y-4 w-full max-w-xs'>
          ...
          {/* <input className="input w-full" required type="text" placeholder="Name" value={name} onChange={e => setName(e.target.value)} /> */}
          ...
          <label className="input">
            ...
            <input type="input" required placeholder="Name" minlength="3" maxlength="30" value={name} onChange={e => setName(e.target.value)} />
          </label>
